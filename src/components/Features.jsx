        ...
        <div className='flex flex-col justify-center items-center overflow-hidden'>
          ...
          <div className='flex-center flex-col sm:px-10'>
            <div className='relative h-[50vh] w-full'>
              ...
              h-full object-cover object-center' preload='none' autoPlay muted playsInline ref={videoRef} id='exploreVideo'>
            ...
            <div className='flex flex-col w-full relative'>
              ...
              <div className='feature-text-container pb-10'>
                <div className='flex-1 flex-center'>
                  <p className='feature-text g_text'>iPhone 15 Pro is {' '}
                    <span className='text-white'>
                        the first iPhone built by titanium and built with great design
                    </span>
